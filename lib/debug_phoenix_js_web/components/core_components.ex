defmodule DebugPhoenixJsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DebugPhoenixJsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DebugPhoenixJsWeb.Gettext, "errors", msg, opts)
    end
  end
